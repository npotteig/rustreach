...
if __name__ == '__main__':
    ...
    parser.add_argument("-s", "--states_csv_file", type=str)
    parser.add_argument("-r", "--rects_csv_file", type=str)
    parser.add_argument("-o", "--output_path", default=None, type=str)
    args = parser.parse_args()

    reach_time = 2
    states_df = pd.read_csv(args.states_csv_file)
    rects_df = pd.read_csv(args.rects_csv_file)
